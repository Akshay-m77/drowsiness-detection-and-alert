		...
		<div class="page-wrapper">
            <div class="container-fluid pt-25">
				...
				<h2>Driver Details</h2>
					<hr>
       			<?php
                        $result = $db->prepare("select * from users where OLog_Id='$Log_Id' and user_type='Driver'  and cntno like'%".$cntno."%'");
                        $result->execute();
							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body pa-0">
									<article class="col-item">
										...
										<div class="info">
                                        	<hr>
											<h6>NAME <?php echo $rows['name'];?></h6>
                                            <hr>
											<div class="product-rating inline-block">
												Age <?php echo $rows['age'];?>
											</div>
                                           	<hr>
											<div class="product-rating inline-block">
                                            ...
                                            <hr>
											<div class="product-rating inline-block">
												LICENSE NO <?php echo $rows['lno'];?>
											</div>
											<hr>	
                                            <div class="product-rating inline-block">
												LICENSE DATE <?php echo $rows['ldate'];?>
											</div>
											<hr>
                                            <div class="product-rating inline-block">
												VEHICLE NO <?php echo $rows['vno'];?>
											</div>
											<hr>                                           
                                            <div class="product-rating inline-block">
                                            ...
                                            <div class="row">
                                                ...
                                                <a href="driver_edit.php?user_id=<?php echo $rows['user_id'];?>" class="btn btn-block btn-primary">EDIT</a>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                               <a href="action/driver_delete.php?user_id=<?php echo $rows['user_id'];?>" class="btn btn-block btn-danger">REMOVE</a>
                                                </div>
                                            </div>
                                            <br>										
