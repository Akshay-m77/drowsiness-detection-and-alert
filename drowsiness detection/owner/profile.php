 										...
 										<div class="row">
                                            ...
                                            <div class="col-md-6">
 												<div class="form-group">
 													...
 													<input type="text" class="form-control" placeholder="Location" name="ulocation" value="<?php echo $ulocation ?>" required>
 												</div>
 											</div>
 											<div class="col-md-6">
 												<div class="form-group">
                                            ...
                                            <div class="col-md-6">
 												<div class="form-group">
 													...
 													<input type="number" class="form-control" placeholder="Age" name="age" value="<?php echo $age ?>" min="18" max="80" required>
 												</div>
 											</div>
 											<div class="col-md-6">
 												<div class="form-group">
