		...
		<div class="page-wrapper">
            <div class="container-fluid pt-25">
				...
				<h2>Owner Details</h2>
					<hr>
       			<?php
                        $result = $db->prepare("select * from users where user_type='Owner' and cntno like'%".$cntno."%'");
                        $result->execute();
									...
									<article class="col-item">
										...
										<div class="info">
                                            ...
                                            <div class="row">
                                                ...
                                                <a href="owner_edit.php?user_id=<?php echo $rows['user_id'];?>" class="btn btn-block btn-primary">EDIT</a>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                               <a href="action/owner_delete.php?user_id=<?php echo $rows['user_id'];?>" class="btn btn-block btn-danger">REMOVE</a>
                                                </div>
                                            </div>
                                            <br>										
