 				...
 				<div class="row">
 					...
 					<div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
 						<div class="panel panel-default card-view">
 							<div class="panel-heading">
 								<div class="pull-left">
 									<h6 class="panel-title txt-dark">Profile Update</h6>
 								</div>
 								<div class="clearfix"></div>
 							</div>
 							<div class="panel-wrapper collapse in">
 										...
 										<div class="row">
                                            ...
                                            <div class="col-md-6">
 												<div class="form-group">
 													...
 													<input type="number" class="form-control" placeholder="Age" name="age" value="<?php echo $age ?>" min="18" max="55" required>
 												</div>
 											</div>
 											<div class="col-md-6">
 												<div class="form-group">
 													<label class="control-label mb-10">Gender</label>
 													<input type="text" class="form-control" placeholder="Gender" name="sex" value="<?php echo $sex ?>" required>
 												</div>
 											</div>
                                            <div class="col-md-6">
 												<div class="form-group">
